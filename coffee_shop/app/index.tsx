    ...
    <SafeAreaView className="flex-1 bg-black">
      ...
      >
        ...
        <View className="absolute bottom-0 left-0 right-0 bg-black/75 pt-12 pb-10 px-6 items-center">
          ...
          <Text className="text-white text-[32px] font-semibold text-center mb-4 leading-[48px]">
            Fall in Love with Coffee in Blissful Delight!
          </Text>
          <Text className="text-[#A2A2A2] text-md font-normal text-center mb-10 leading-[21px]">
